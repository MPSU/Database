...
#### Задание 2.
Используя программу PgAdmin изучите учебную базу данных Students: 
...
#### Задание 5. 
Работа с программой ОРИОКС (по вариантам)
Предположим, что студентка группы ИТД-33 Коровина Мария Георгиевна вышла замуж за студента c номером студенческого билета 894279. Измените её фамилию на фамилию её супруга.
